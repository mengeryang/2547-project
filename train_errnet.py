...
if __name__ == '__main__':
    ...
    datadir_syn = join(datadir, 'VOCdevkit/VOC2012/JPEGImages/')
    datadir_real = join(datadir, 'real/')

    # training data from VOC2012, synthetic
    ...
    # training data from Berkeley real dataset, real
    train_dataset_real = datasets.CEILTestDataset(datadir_real, fns=read_fns('real_train.txt'), enable_transforms=True)
    ...
    # test data from CEILNet dataset, synthetic
